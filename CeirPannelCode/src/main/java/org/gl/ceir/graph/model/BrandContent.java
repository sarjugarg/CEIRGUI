...
public class BrandContent {
	...
	private BrandModelGrapContent content;
	...
	public BrandModelGrapContent getContent() {
		return content;
	}


	public void setContent(BrandModelGrapContent content) {
	...
	public String toString() {
		...
		builder.append("BrandContent [content=");
